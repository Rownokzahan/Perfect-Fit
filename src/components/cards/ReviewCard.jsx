import bgCircle from "../../assets/images/logo-icon/circle.avif";
import { BsStarFill } from "react-icons/bs";

const ReviewCard = ({ review }) => {
  return (
    <div key={review.id} className="relative ms-6">
      <div className="w-fit absolute -top-8 -left-8 z-10">
        <div className="relative">
          <img src={bgCircle} className="w-20" alt="" />
          <img
            src={review.image}
            className="absolute w-[85%] top-px left-[11px] object-cover rounded-full"
          />
        </div>
      </div>
      <div className="relative h-full p-10 border rounded flex flex-col justify-between">
        <p>{review.comment}</p>
      ...
      <div className="absolute bottom-3 right-10 opacity-20">
        <svg
          className="fill-current text-secondary-black w-20"
          fill="#f1f1f1"
          height="110px"
          width="110px"
          version="1.1"
